...
class CleanupCountdownTest {
    ...
    void startsAtConfiguredIntervalInTicks() {
        CleanupCountdown countdown = new CleanupCountdown(new CleanConfig(30, List.of(10, 5), List.of()));
    ...
    void emitsWarningsAtConfiguredRemainingSeconds() {
        CleanupCountdown countdown = new CleanupCountdown(new CleanConfig(3, List.of(2, 1), List.of()));
    ...
    void emitsCleanupAndResetsWhenTimeReachesZero() {
        CleanupCountdown countdown = new CleanupCountdown(new CleanConfig(1, List.of(), List.of()));
    ...
    void supportsLargeIntervalsWithoutOverflowingTicks() {
        CleanupCountdown countdown = new CleanupCountdown(new CleanConfig(200_000_000, List.of(), List.of()));
    ...
    void resetUsesLatestConfigAndClearsWarningHistory() {
        CleanupCountdown countdown = new CleanupCountdown(new CleanConfig(10, List.of(5), List.of()));

        countdown.reset(new CleanConfig(2, List.of(1), List.of()));
