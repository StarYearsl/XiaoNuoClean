...
class CleanupCountdownTest {
    ...
    void startsAtConfiguredIntervalInTicks() {
        CleanupCountdown countdown = new CleanupCountdown(new CleanConfig("zh-CN", 30, List.of(10, 5), List.of()));
    ...
    void emitsWarningsAtConfiguredRemainingSeconds() {
        CleanupCountdown countdown = new CleanupCountdown(new CleanConfig("zh-CN", 3, List.of(2, 1), List.of()));
    ...
    void emitsCleanupAndResetsWhenTimeReachesZero() {
        CleanupCountdown countdown = new CleanupCountdown(new CleanConfig("zh-CN", 1, List.of(), List.of()));
    ...
    void supportsLargeIntervalsWithoutOverflowingTicks() {
        CleanupCountdown countdown = new CleanupCountdown(new CleanConfig("zh-CN", 200_000_000, List.of(), List.of()));
    ...
    void resetUsesLatestConfigAndClearsWarningHistory() {
        CleanupCountdown countdown = new CleanupCountdown(new CleanConfig("zh-CN", 10, List.of(5), List.of()));

        countdown.reset(new CleanConfig("zh-CN", 2, List.of(1), List.of()));
